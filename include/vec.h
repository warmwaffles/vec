...
#define vec_get(v, idx) ((v)->data[idx])

#define vec_size(v) ((v)->length)
...
#define vec_append(v, v2) vec_pusharr((v), (v2)->data, (v2)->length)
...
int vec_expand_(char **data, int *length, int *capacity, size_t memsz);

int vec_reserve_(char **data, int *length, int *capacity, size_t memsz, int n);

int vec_reserve_po2_(char **data, int *length, int *capacity, size_t memsz, int n);

int vec_compact_(char **data, int *length, int *capacity, size_t memsz);

int vec_insert_(char **data, int *length, int *capacity, size_t memsz, int idx);

void vec_splice_(char **data, int *length, int *capacity, size_t memsz, int start, int count);

void vec_swapsplice_(char **data, int *length, int *capacity, size_t memsz, int start, int count);

void vec_swap_(char **data, int *length, int *capacity, size_t memsz, int idx1, int idx2);

#ifdef VEC_DEFINE_DEFAULTS
